...
class PDF extends FPDF
{
    ...
    function datosVertical($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->RoundedRect(10, $ejeY, 320, 7, 2, $letra);
            //$this->CellFitSpace(40,7, utf8_decode($fila['id_user']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['id']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['cargo']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['vehiculo']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['color']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['placa']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['serie']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['marca']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['propietario']),0, 0 , 'L' );
