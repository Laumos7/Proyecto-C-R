...
class PDF extends FPDF
{
    ...
    function datosVertical($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(40,7, utf8_decode($fila['user']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['email']),'LR', 0 , 'L' );
           $this->CellFitSpace(40,7, utf8_decode($fila['rol']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['pasguarda']),0, 0 , 'L' );
