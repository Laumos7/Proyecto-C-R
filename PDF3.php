...
class PDF extends FPDF
{
    ...
    function datosVertical($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->RoundedRect(10, $ejeY, 200, 7, 2, $letra);
            //$this->CellFitSpace(40,7, utf8_decode($fila['id_user']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['idnovedad']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['descripcion']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['documento']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['novedad']),'LR', 0 , 'L' );
