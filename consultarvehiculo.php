...
$result = mysqli_query($mysqli,"SELECT COUNT(*) FROM VEHICULO where Propietario='$result1' ");
...
<body>
	<div class="contenedor-formulario">
			...
			<form action="index.php" class="formulario" name="formulario_registro" method="POST">
				<div>	
						<center><Font color=black SIZE=12 face=comic-sans>Vehiculo Consultado</Font></center>
						<br><br><br>
					<?php
						echo "<Font color=black>";
						extract($_GET);
						$result1=$_POST['correo'];			 
        				$sql=("SELECT * FROM VEHICULO where Propietario='$result1'");
            			...
            			echo "<td>Tipo de vehiculo</td>";
            			echo "<td>Color</td>";
            			echo "<td>Placa o Numero de rin</td>";
            			echo "<td>Serial</td>";
            			echo "<td>Marca</td>";
            			echo "<td>Documento Propietario</td>";     
          				echo "</tr>"; 
      				?>
       			   <?php 
			 ...
			 <center><img src="../view/images/consu.jpg" width=""> 			  
