...
class PDF extends FPDF
{
    ...
    function datosVertical($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(40,7, utf8_decode($fila['Id_usuario']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['Nombre']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['Apellido']),'LR', 0 , 'L' );                
            $this->CellFitSpace(40,7, utf8_decode($fila['Documento']),0, 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['Edad']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['Direccion']),'LR', 0 , 'L' );
            $this->CellFitSpace(40,7, utf8_decode($fila['Estado']),'LR', 0 , 'L' );
